namespace Fq.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Long(nullable: false, identity: true),
                        IsChuKu = c.Boolean(nullable: false),
                ...
                c => new
                    {
                        ...
                        LoginCode = c.String(unicode: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Long(nullable: false, identity: true),
                        TransitonId = c.Long(nullable: false),
                        UserName = c.String(unicode: false),
                        TradingType = c.Int(nullable: false),
                        Amount = c.Double(nullable: false),
                ...
                annotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_TradingRecord_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AbpUsers", t => t.CreatorUserId)
                .ForeignKey("dbo.AbpUsers", t => t.DeleterUserId)
                .ForeignKey("dbo.AbpUsers", t => t.LastModifierUserId)
                .ForeignKey("dbo.AbpOrganizationUnits", t => t.OrgId, cascadeDelete: true)
                .ForeignKey("dbo.g_transition", t => t.TransitonId, cascadeDelete: true)
                .Index(t => t.TransitonId)
                .Index(t => t.OrgId)
                .Index(t => t.DeleterUserId)
                .Index(t => t.LastModifierUserId)
                .Index(t => t.CreatorUserId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Long(nullable: false, identity: true),
                        ParentId = c.Long(),
                        JieBanGold = c.Double(nullable: false),
                        JieBanCard = c.Double(nullable: false),
                        JieBanCash = c.Double(nullable: false),
                        Code = c.String(unicode: false),
                        IsComplete = c.Boolean(nullable: false),
                        JiaoBanDateTime = c.DateTime(precision: 0),
                        JiaoBanGold = c.Double(nullable: false),
                        JiaoBanCard = c.Double(nullable: false),
                        JiaoBanCash = c.Double(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AbpUsers", t => t.CreatorUserId)
                .ForeignKey("dbo.g_transition", t => t.ParentId)
                .Index(t => t.ParentId)
                .Index(t => t.CreatorUserId);
        ...
        {
            DropForeignKey("dbo.g_tradingrecord", "TransitonId", "dbo.g_transition");
            DropForeignKey("dbo.g_transition", "ParentId", "dbo.g_transition");
            DropForeignKey("dbo.g_transition", "CreatorUserId", "dbo.AbpUsers");
            DropForeignKey("dbo.g_tradingrecord", "OrgId", "dbo.AbpOrganizationUnits");
            DropForeignKey("dbo.g_tradingrecord", "LastModifierUserId", "dbo.AbpUsers");
            DropForeignKey("dbo.g_tradingrecord", "DeleterUserId", "dbo.AbpUsers");
            DropForeignKey("dbo.g_tradingrecord", "CreatorUserId", "dbo.AbpUsers");
            ...
            DropForeignKey("dbo.g_inventory", "CreatorUserId", "dbo.AbpUsers");
            ...
            DropIndex("dbo.g_transition", new[] { "CreatorUserId" });
            DropIndex("dbo.g_transition", new[] { "ParentId" });
            DropIndex("dbo.g_tradingrecord", new[] { "CreatorUserId" });
            DropIndex("dbo.g_tradingrecord", new[] { "LastModifierUserId" });
            DropIndex("dbo.g_tradingrecord", new[] { "DeleterUserId" });
            DropIndex("dbo.g_tradingrecord", new[] { "OrgId" });
            DropIndex("dbo.g_tradingrecord", new[] { "TransitonId" });
            ...
            DropIndex("dbo.g_inventory", new[] { "CreatorUserId" });
            ...
            DropTable("dbo.g_transition");
            DropTable("dbo.g_tradingrecord",
                removedAnnotations: new Dictionary<string, object>
                {
                    { "DynamicFilter_TradingRecord_SoftDelete", "EntityFramework.DynamicFilters.DynamicFilterDefinition" },
                });
