        ...
        function ($scope, $uibModal, uiGridConstants, appUserNotificationHelper, notificationService) {
                ...
                columnDefs: [
                    {
                        ...
                        cellTemplate:
                            ...
                            '  <button ng-click="grid.appScope.setNotificationAsRead(row.entity)" ng-disabled="row.entity.state==\'READ\'" class="btn btn-xs btn-primary blue" title="设置为已读">' +
            ...
            vm.getNotifications = function () {
                ...
                notificationService.getUserNotifications({
                    ...
                    vm.gridOptions.data = _.map(result.items, function(item) {
