...
(function () {
    ...
    var appLocalizationSource = abp.localization.getSource('Fq');
    ...
    app.createDateRangePickerOptions = function () {
        ...
        options.ranges['当月'] = [moment().startOf('month'), moment().endOf('month')];
        options.ranges['上月'] = [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')];
